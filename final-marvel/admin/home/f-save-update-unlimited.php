...
$sql = "update unlimited_comic set image ='{$main_file_name}', title ='{$title}', description ='{$desc}', btn_name ='{$btn_title}', btn_link = '{$btn_link}', date = '{$date}', author = 'cynthia' where id = {$u_id}";
