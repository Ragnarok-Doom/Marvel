...
if(isset($_POST['submit'])){
    ...
    if (empty($errors)) {
        ...
        $sql = "insert into tvshow(title, title_image, category, poster_image, main_image, button_name, button_link, trailer_link, description, director, writter, rating, run_time, release_date, img1, img2, img3, img4, img5, img6, img7, img8, img9, img10, img11, img12) values('$title', '$title_image', '$cate' , '$poster_image', '$main_image', '$btn_name', '$btn_link', '$trailer_link', '$desc', '$director', '$writter', '$rating', '$run_time', '$date', '$img1', '$img2', '$img3', '$img4', '$img5', '$img6', '$img7', '$img8', '$img9', '$img10', '$img11', '$img12')";
        $result = mysqli_query($conn, $sql) or die("query failed 2" . mysqli_error($conn));
        
        if ($result > 0) {
            echo '<script>alert("Record added successfully!"); window.location.href = "'.$hostname.' /admin/tvshow/index-tvshow.php";</script>';
        } else {    
            echo '<script>alert("Failed to add record. Please try again."); window.location.href = "'.$hostname.' /admin/tvshow/form-tvshow.php";</script>';
        }
    }
}
...
<div id="admin-content">
      <div class="container">
         <div class="row"  style="justify-content: center;">
             <div class="col-md-12">
                 <h1 class="admin-heading">Add Tv Show</h1>
             </div>
