...
function processImage($file, $type, $old_image)
{
    ...
    if (empty($errors)) {
        ...
        if (!empty($old_image)) {
            $old_image_path = "tvshow-image/" . $old_image;
        ...
        move_uploaded_file($file_temp, "tvshow-image/" . $new_file_name);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        $sql = "UPDATE tvshow 
                ...
                if ($result > 0) {
                    echo '<script>alert("Record added successfully!"); window.location.href = "'.$hostname.' /admin/tvshow/index-tvshow.php";</script>';
                } else {    
                    echo '<script>alert("Failed to add record. Please try again."); window.location.href = "'.$hostname.' /admin/tvshow/form-update-tvshow.php";</script>';
                }
    }
}
...
<div id="admin-content">
      <div class="container">
         <div class="row"  style="justify-content: center;">
             <div class="col-md-12">
                 <h1 class="admin-heading">Update Tv Show</h1>
             </div>
              <div class="col-md-offset-3 col-md-6">
                  ...
                  <form  action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <img id="title-image-preview"  src="admin/tvshow/tvshow-image/<?php echo $row1['title_image']; ?>" height="150px">
                      ...
                      <div class="form-group">
                        ...
                        <select name="cate" class="form-control">
                            <?php
                                ...
                                $sql2 = "select * from show_category";
                       ...
                       <div class="form-group">
                            ...
                            <img id="poster-image-preview"  src="admin/tvshow/tvshow-image/<?php echo $row1['poster_image']; ?>" height="150px">
                      ...
                      <div class="form-group">
                            ...
                            <img id="main-image-preview"  src="admin/tvshow/tvshow-image/<?php echo $row1['main_image']; ?>" height="150px">
                ...
                <div class="row" style="justify-content: center; padding: 20px; box-shadow: 0 0 5px 2px rgba(0, 0, 0, 0.1); border-radius: 10px;">
                    <div class="col-md-offset-3 col-md-5">
                        <div class="form-group">
                            ...
                            <img id="img1-image-preview"  src="admin/tvshow/tvshow-image/<?php echo $row1['img1']; ?>" height="150px">
                    ...
                    <div class="col-md-offset-3 col-md-5">
                        <div class="form-group">
                            ...
                            <img id="img2-image-preview"  src="admin/tvshow/tvshow-image/<?php echo $row1['img2']; ?>" height="150px">
                    ...
                    <div class="col-md-offset-3 col-md-5">
                        <div class="form-group">
                            ...
                            <img id="img3-image-preview"  src="admin/tvshow/tvshow-image/<?php echo $row1['img3']; ?>" height="150px">
                    ...
                    <div class="col-md-offset-3 col-md-5">
                        <div class="form-group">
                            ...
                            <img id="img4-image-preview"  src="admin/tvshow/tvshow-image/<?php echo $row1['img4']; ?>" height="150px">
                    ...
                    <div class="col-md-offset-3 col-md-5">
                        <div class="form-group">
                            ...
                            <img id="img5-image-preview"  src="admin/tvshow/tvshow-image/<?php echo $row1['img5']; ?>" height="150px">
                    ...
                    <div class="col-md-offset-3 col-md-5">
                        <div class="form-group">
                            ...
                            <img id="img6-image-preview"  src="admin/tvshow/tvshow-image/<?php echo $row1['img6']; ?>" height="150px">
                    ...
                    <div class="col-md-offset-3 col-md-5">
                        <div class="form-group">
                            ...
                            <img id="img7-image-preview"  src="admin/tvshow/tvshow-image/<?php echo $row1['img7']; ?>" height="150px">
                    ...
                    <div class="col-md-offset-3 col-md-5">
                        <div class="form-group">
                            ...
                            <img id="img8-image-preview"  src="admin/tvshow/tvshow-image/<?php echo $row1['img8']; ?>" height="150px">
                    ...
                    <div class="col-md-offset-3 col-md-5">
                        <div class="form-group">
                            ...
                            <img id="img9-image-preview"  src="admin/tvshow/tvshow-image/<?php echo $row1['img9']; ?>" height="150px">
                    ...
                    <div class="col-md-offset-3 col-md-5">
                        <div class="form-group">
                            ...
                            <img id="img10-image-preview"  src="admin/tvshow/tvshow-image/<?php echo $row1['img10']; ?>" height="150px">
                    ...
                    <div class="col-md-offset-3 col-md-5">
                        <div class="form-group">
                            ...
                            <img id="img11-image-preview"  src="admin/tvshow/tvshow-image/<?php echo $row1['img11']; ?>" height="150px">
                    ...
                    <div class="col-md-offset-3 col-md-5">
                        <div class="form-group">
                            ...
                            <img id="img12-image-preview"  src="admin/tvshow/tvshow-image/<?php echo $row1['img12']; ?>" height="150px">
