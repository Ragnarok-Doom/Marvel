...
<div class="movie-header">
    <?php
        if($row['main_image'] != ""){
    ?>
    <img src="admin/movie/movie-image/<?php echo $row['main_image']; ?>" class="main-img" alt="">
    <?php }else{ ?>
    <img src="admin/movie/movie-image/<?php echo $row['poster_image']; ?>" style="margin-right: 200px;" class="main-img" alt="">
    <?php } ?>
    <div class="overlay"></div>
    <div class="title-img">
        <img src="admin/movie/movie-image/<?php echo $row['title_image']; ?>" style="width: 400px;" alt="">
	...
	<div class="movie-overview">
		...
		<div class="content-photo">
			...
			<div class="movie-image">
				<img src="admin/movie/movie-image/<?php echo $row['poster_image']; ?>">
			</div>
		</div>
...
<?php
    if($row['img1'] != "" && $row['img2'] != "" && $row['img3'] != "" && $row['img4'] != "" && $row['img5'] != "" && $row['img6'] != "" && $row['img7'] != "" && $row['img8'] != "" && $row['img9'] != "" && $row['img10'] != "" && $row['img11'] != "" && $row['img12'] != ""){
?>
<div class="gallery">
    <h1>GALLERY</h1>
    <br><br><br>
        ...
        <div class="col">
            <div class="card-columns" style="padding: 0 50px;">
                <div class="card border">
                    <img src="admin/movie/movie-image/<?php echo $row['img1']; ?>" alt="" class="img-fluid">
                </div>
                <div class="card border">
                    <img src="admin/movie/movie-image/<?php echo $row['img2']; ?>" alt="" class="img-fluid">
                </div>
                <div class="card border">
                    <img src="admin/movie/movie-image/<?php echo $row['img3']; ?>" alt="" class="img-fluid">
                </div>
                <div class="card border">
                    <img src="admin/movie/movie-image/<?php echo $row['img4']; ?>" alt="" class="img-fluid">
                </div>
                <div class="card border">
                    <img src="admin/movie/movie-image/<?php echo $row['img5']; ?>" alt="" class="img-fluid">
                </div>
                <div class="card border">
                    <img src="admin/movie/movie-image/<?php echo $row['img6']; ?>" alt="" class="img-fluid">
                </div>
                <div class="card border">
                    <img src="admin/movie/movie-image/<?php echo $row['img7']; ?>" alt="" class="img-fluid">
                </div>
                <div class="card border">
                    <img src="admin/movie/movie-image/<?php echo $row['img8']; ?>" alt="" class="img-fluid">
                </div>
                <div class="card border">
                    <img src="admin/movie/movie-image/<?php echo $row['img9']; ?>" alt="" class="img-fluid">
                </div>
                <div class="card border">
                    <img src="admin/movie/movie-image/<?php echo $row['img10']; ?>"  alt="" class="img-fluid" style="width: 100%;">
                </div>
                <div class="card border">
                    <img src="admin/movie/movie-image/<?php echo $row['img11']; ?>" alt="" class="img-fluid">
                </div>
                <div class="card border">
                    <img src="admin/movie/movie-image/<?php echo $row['img12']; ?>" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="comic-main-container">
        <div class="only-comic" STYLE="">
            <?php
                ...
                $sql4 = "select * from movie where title like '%$tit%' order by rand() limit 5";
                $result4 = mysqli_query($conn, $sql4) or die("query failed");
                while($row4 = mysqli_fetch_assoc($result4)){

            ?>
            <div class="the-comic" STYLE="">
                <a href="movie-content.php?id=<?php echo $row4['id']; ?>&tit=<?php echo $row4['title']; ?>"><img src="admin/movie/movie-image/<?php echo $row4['poster_image']; ?>" alt=""></a><br>
                <!-- <div class="comic-image-content"> -->
                    <a href="movie-content.php?id=<?php echo $row4['id']; ?>&tit=<?php echo $row4['title']; ?>" style="color: white; text-align: center;"><b><h5><?php echo $row4['title']; ?></h5></b></a>
                <!-- </div> -->
            </div>
            <?php } ?>
        </div>
...
$sql2 = "select * from movie where id = $id";
...
<div class="upcom" style="width: 100%; height: 90vh; display: flex; justify-content: center; align-items: center; gap: 50px;">
    <img src="admin/movie/movie-image/<?php echo $row2['poster_image']; ?>" alt="" style="width: 300px; height: 500px;">
